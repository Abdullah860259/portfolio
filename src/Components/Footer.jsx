...
const Footer = () => {
    return (
        <>
            {/* <div className='' ></div>
            <footer className=' w-full h-[50vh] flex justify-between items-center gap-4 p-4 sm:p-10 '>
                <div className='h-full flex flex-col justify-between items-start ' >
                    <ul className='flex justify-center  items-center gap-4 flex-row ' >
                        ...
                        <li className="twitter-icon  text-[#1788ae] hover:scale-110 transition duration-100 active:scale-90">
                            <a href="https://x.com/Abdulla55799774" target="_blank"><i class="fab fa-twitter"></i></a>
                        </li>
                        <li className="instagram-icon  text-[#1788ae] hover:scale-110 transition duration-100 active:scale-90">
                            <a href="https://www.instagram.com/abdu_7817/" target="_blank"><i class="fab fa-instagram"></i></a>
                        </li>
                        <li className="gmail-icon  text-[#1788ae] hover:scale-110 transition duration-100 active:scale-90">
                            <a href="mailto:abdullah860259@gmail.com" target="_blank"><i class="far fa-envelope"></i></a>
                        </li>
                        <li className="github-icon  text-[#1788ae] hover:scale-110 transition duration-100 active:scale-90">
            ...
            <hr class="mt-16 mb-10 w-[95vw] translate-x-[2vw] border-gray-400" />
            <section class="py-10 select-none bg-gray-50 sm:pt-16 lg:pt-24">
                <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div class="grid grid-cols-2 md:col-span-2 lg:grid-cols-5 gap-y-16 gap-x-6">
                        <div class="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                            <div className='flex justify-start gap-3 items-center' >
                                ...
                                <p className=' font-sans text-lg     md:text-3xl text-[#1a487a] font-extrabold ' >Hafiz Abdullah Anwar</p>
                            </div>
                            <p class="text-base leading-relaxed text-gray-600 mt-7">Building modern, fast, and user-focused web experiences with clean code and thoughtful design. Passionate about turning ideas into reliable digital solutions using the latest web technologies.</p>
                        ...
                        <div>
                            ...
                            <ul class="mt-6 space-y-4">
                                <li>
                                    <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Profile</a>
                                </li>

                                <li>
                                    <a href="#" title="" class="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> NET Experience</a>
                                </li>
                    ...
                    <p class="text-sm text-center text-gray-600">Hafiz Abdullah Anwar | Copyright &copy; 2026 | All Rights Reserved</p>
                </div>
            </section>
