  ...
  rounded-2xl text-white h-auto bg-[#191919]  overflow-hidden sm:min-h-[90%] flex flex-col  md:flex-row items-center md:justify-between justify-around px-2 md:px-6 lg:px-12 py-2 md:py-8 relative">
            ...
            <section
                ...
                <div className='after:contents-[""] after:hidden after:sm:block relative after:absolute after:w-[40%] after:h-[2px]  after:bg-[#6f11b0]  after:top-[50%] after:left-[10%]  '>
                    <a href="https://fundyourproject.vercel.app" target="_blank" rel="noopener noreferrer">
                    ...
                    <div className="project w-full max-w-screen-xl xl:py-40  overflow-hidden flex justify-center items-center py-4 px-2  flex-col ">
                        <div className="project w-full   h-[100dvh] sm:h-auto  py-10 px-5 sm:px-0 gap-10 flex sm:flex-row flex-col justify-center items-center content-center sm:justify-between sm:items-center">
                            <AnimateOnScroll>
                                <a href="https://fundyourproject.vercel.app" className='flex  justify-center items-center' target="_blank" rel="noopener noreferrer">
                                    <img className='sm:w-[260px] relative z-30 md:w-[330px] lg:w-[450px] w-[85%] h-auto ml-0 sm:ml-10 hover:scale-110 transition duration-100 ease-in  ' src="/Group7.webp" alt="Project 1" />
                                </a>
                                <span className='w-auto opacity-0 group-hover:opacity-100 group-hover:-translate-y-12 flex justify-center items-center gap-2 transition duration-200  ease-jump  h-auto px-5 py-2 bg-[#6d11b0] rounded-lg absolute -top-[30px] left-1/2 -translate-x-[73px] text-white z-50 after:content-[""] after:absolute after:w-[15px] after:h-[15px] after:bg-[#6d11b0] after:top-[30px] after:rounded-sm after:left-1/2 after:-translate-x-1/2 after:rotate-45' >
                                    Fund Your Project
                            ...
                            <AnimateToTopAtScroll className={'text-black w-full   sm:w-[45%] h-auto flex flex-col justify-items-start gap-6 sm:gap-4 sm:pr-12  '}>
                                <h2 className='text-2xl  md:text-3xl font-bold select-none name  text-[#6e11b0]' >Fund Your Project
                                </h2>
                                <p className='text-[16px] md:text-xl select-none name  text-[#6e11b0]' >{"(Crowd Funding Project)"}</p>
                                <p className='text-[14px]'>Empowering ideas, transforming communities. This crowdfunding project provides a secure and transparent platform that helps individuals and organizations raise funds for meaningful causes. By combining innovation with trust, it ensures every contribution creates real impact and drives ideas from concept to reality</p>
                                <ul className='flex row flex-wrap gap-2 text-[12px] md:text-sm select-none' >
                                    <li className='px-2 py-2 border-[1px] border-[#0000007c] rounded-2xl ' >#Next js</li>
                                    ...
                                    <li className='px-2 py-2 border-[1px] border-[#0000007c] rounded-2xl ' >#Swiper js</li>
                                    <li className='px-2 py-2 border-[1px] border-[#0000007c] rounded-2xl ' >#Daisy UI</li>
