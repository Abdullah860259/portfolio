  ...
  return (
    <>
      <div ref={ref} className='Nav transition-opacity ease-in-out duration-100 delay-500 pointer-events-none w-full px-6 py-3 md:px-16 max-w-screen-xl flex justify-between items-center absolute top-0'>
        <svg className='cursor-pointer pointer-events-auto hover:opacity-80 duration-150 sm:w-[70px] sm:h-[70px] w-14 h-14  transition-opacity ease-in-out  ' onClick={() => window.location.reload()} viewBox="0 0 406 368" fill="none" xmlns="http://www.w3.org/2000/svg">
