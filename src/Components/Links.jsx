...
const Links = React.forwardRef((props, ref) => {
    return (
        <>
            <div
                ref={ref}
                className="links -translate-y-1 mr-4 md:mr-10 flex gap-5 relative z-20 text-2xl text-gray-600 flex-col ml-auto "
            >
                <a
                    href="https://www.linkedin.com/in/abdullah-anwar-a4013633a/"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="LinkedIn Profile of Abdullah Anwar"
                >
                ...
                <a
                    href="https://x.com/Abdulla55799774"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Twitter Profile of Abdullah Anwar"
                >
                ...
                <a
                    href="https://www.instagram.com/abdu_7817/"
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="Instagram Profile of Abdullah Anwar"
                >
                ...
                <a href="mailto:abdullah860259@gmail.com" aria-label="Send Email to Abdullah Anwar">
                ...
                <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    aria-label="GitHub Profile of Abdullah Anwar"
                >
